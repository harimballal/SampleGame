...
Game.unity2_1_1alevel1.prototype ={
	...
	correctAns:function(target)
	{
       ...
       //telInitializer.tele_saveAssessment(_this.questionid,"yes",_this.AnsTimerCount,_this.noofAttempts,_this.sceneCount);
        ...
        telInitializer.tele_interactEvent("TOUCH",target.name);
        telInitializer.tele_saveAssessment(_this.questionid,"yes",this.res);
    ...
    wrongAns:function(target)
	{
       ...
       // target.tint = 0xA9A9A9;
	    ...
	    telInitializer.tele_interactEvent("TOUCH",target.name);
        telInitializer.tele_saveAssessment(_this.questionid,"no",this.res);
    ...
    getVoice:function()
    {
        ...
        switch(_this.qArrays[_this.no11])
        {
            ...
            case 10://if(window.languageSelected=="English")
                   // {
                        _this.src.setAttribute("src", "questionSounds/2.1.1/English/question2.1.mp3");
                   /* }
